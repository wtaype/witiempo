import{g as i,$ as t,s as l,N as m}from"./main-CgV4wx7D.js";let o={format:i("clockFormat")||"24",showDate:i("clockShowDate")||!1,size:i("clockSize")||12},a=null;const c=()=>{const e=new Date;let s=e.getHours();const f=e.getMinutes(),w=e.getSeconds();let n=s,r="";o.format==="12"?(r=s>=12?"PM":"AM",n=s%12||12,t("#clockAmPm").text(r).show()):t("#clockAmPm").hide();const v=`${String(n).padStart(2,"0")}:${String(f).padStart(2,"0")}:${String(w).padStart(2,"0")}`;if(t("#clockTime").text(v),o.showDate){const u={weekday:"long",year:"numeric",month:"long",day:"numeric"},d=e.toLocaleDateString("es-ES",u),k=d.charAt(0).toUpperCase()+d.slice(1);t("#clockDate").text(k).show()}else t("#clockDate").hide()},g=async()=>`
    <!-- RELOJ DIGITAL -->
    <div class="wiclock">
